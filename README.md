...
✅ 예약 조회 API 처리 로직에서 저장된 예약을 조회, 저장, 삭제할 때 데이터베이스를 활용하도록 수정하세요.  
...
## 🚀  8, 9, 10 단계 - Spring Core


### 📝 기능 요구사항
✅ 방탈출 시간을 등록하는 기능을 추가하세요     
...
1. Time Table 생성   
   ➡️ 시간을 등록,삭제,조회하는 API 구현 (Time controller, service, DAO 구현)


2. 기존 Reservation테이블과 Time테이블의 의존관계 추가   
   ➡️ Reservation DAO 로직 수정 (join 추가) 
